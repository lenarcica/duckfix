...
LOAD duckfix;
-- Now to run the function you declared:
create or replace table exfmt2 as select * from read_fixlog(verbose := 4, char_sep := ' ', file_name := './example/ex_fmt2.csv', json_file_name:= 'config_jsons/fix42_t2.json'); from exfmt2;
