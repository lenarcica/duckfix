...
LOAD duckfix;
-- Now to run the function you declared:
create or replace table ex3 as select * from read_fixlog(verbose := 1, char_sep := ' ', file_name := './example/ex_random3.csv', json_file_name:= 'config_jsons/fix42_t2.json'); from ex3;
